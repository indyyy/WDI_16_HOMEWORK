...
moreMorse.split(" ")
Your answer goes here. ["dot", "dash" "pause", "dash", "dot",  dash"]
...
ANSWER: Mick, Keith, Ronnie, Charlie
...
var agePatron=prompt("What is your age")

var hasID = false;

if (agePatron > 21 && agePatron < 75) {
    alert("Come on in")
}
else if ((agePatron > 18) && (agePatron < 21)) {
   alert("Come on in but no drinking")
}
else if (agePatron < 18) {
    alert("You are too young to be in here")
}
else if (agePatron > 75) {
    alert("Are you sure you want to be in here")
}
